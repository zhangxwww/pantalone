...
from libs.utils.timestamp import timestamp_13
...
def _get_uk_stock_info(code):
    time_stamp = timestamp_13()
    url = f"https://gbapi.eastmoney.com/webarticlelist/api/Article/Articlelist?code=lse{code}&sorttype=1&ps=24&from=CommonBaPost&deviceid=quoteweb&version=200&product=Guba&plat=Web&needzd=true&callback=jsonp_1755094696938_1qcqmzl1t2x"
    header = {
        ...
        "DNT": "1",
        "Connection": "keep-alive",
        "Referer": "https://gbfek.eastmoney.com/",
        "Cookie": f"qgqp_b_id=c3c9349b413297e45294a2aac9709bb4; st_si=83553614878347; st_sn=121; st_psi=20250813221816181-113200302461-5678965752; st_asi=delete; fullscreengg=1; fullscreengg2=1; websitepoptg_api_time={time_stamp}; st_nvi=VF0OmB3Nb9ri2cAECNG9nd31c; nid=0550a6613e5f63aaa0098b10b29f6f79; nid_create_time={time_stamp}; gvi=ebhUK-zBYSke0RT7_ZQFl98d5; gvi_create_time={time_stamp}; emshistory=%5B%22{code}%22%5D; st_pvi=10189713117768; st_sp=2023-06-08%2010%3A04%3A31; st_inirUrl=https%3A%2F%2Fwww.baidu.com%2Flink",
    ...
    market = json_obj["bar_info"]["Market"]
    if market == -1:
        return None
    return {
        "股票代码": json_obj["bar_info"]["QCode"],
        "股票简称": json_obj["bar_info"]["ShortName"],
        "公司名称": json_obj["bar_name"],
        "所在市场": "英股",
    }
...
def get_stock_info(code):
    if len(code) == 6 and (code.startswith("6") or code.startswith("0") or code.startswith("3")):
        ...
        try:
            ...
            return _get_uk_stock_info(code)
